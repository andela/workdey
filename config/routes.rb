Rails.application.routes.draw do
  ...
  post "dashboard/task_management_notifications/:id" => "notifications#show_task_management_notification"
  put "dashboard/task_management_notifications/:id" => "notifications#update_task_management_notification"
