Rails.application.routes.draw do
  ...
  post "dashboard/task_management_notifications/:id" => "task_managements#show_notification"
  put "dashboard/task_management_notifications/:id" => "task_managements#update_notification"
